...
var format_GranamoreTimberDams307_10 = new ol.format.GeoJSON();
var features_GranamoreTimberDams307_10 = format_GranamoreTimberDams307_10.readFeatures(json_GranamoreTimberDams307_10, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_GranamoreTimberDams307_10 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_GranamoreTimberDams307_10.addFeatures(features_GranamoreTimberDams307_10);
var lyr_GranamoreTimberDams307_10 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_GranamoreTimberDams307_10, 
                style: style_GranamoreTimberDams307_10,
                popuplayertitle: "Granamore Timber Dams (307)",
                interactive: true,
                title: '<img src="styles/legend/GranamoreTimberDams307_10.png" /> Granamore Timber Dams (307)'
            });
...
lyr_GranamoreTimberDams307_10.set('fieldAliases', {'X': 'X', 'Y': 'Y', 'Name': 'Name', 'description': 'description', 'Date of Construction': 'Date of Construction', });
...
lyr_GranamoreTimberDams307_10.set('fieldImages', {'X': 'TextEdit', 'Y': 'TextEdit', 'Name': 'TextEdit', 'description': 'TextEdit', 'Date of Construction': 'TextEdit', });
...
lyr_CarraigshoukCoir46_1.set('fieldLabels', {'Name': 'header label - visible with data', 'X': 'hidden field', 'Y': 'hidden field', });
lyr_CarraigshoukTimberDams44_2.set('fieldLabels', {'Name': 'header label - visible with data', 'X': 'hidden field', 'Y': 'hidden field', });
lyr_CarrigeenduffSheepFleece31_3.set('fieldLabels', {'Name': 'header label - visible with data', 'X': 'hidden field', 'Y': 'hidden field', });
lyr_CarrigeenduffSheepFleecePiles4_4.set('fieldLabels', {'Name': 'header label - visible with data', 'X': 'hidden field', 'Y': 'hidden field', });
lyr_TulachnTimberDams55_5.set('fieldLabels', {'X': 'hidden field', 'Y': 'hidden field', 'name': 'header label - visible with data', });
lyr_TulachnStoneDams38_6.set('fieldLabels', {'X': 'hidden field', 'Y': 'hidden field', 'name': 'header label - visible with data', });
lyr_TulachnSheepFleece9_7.set('fieldLabels', {'X': 'hidden field', 'Y': 'hidden field', 'name': 'header label - visible with data', });
lyr_TulachnCoir198_8.set('fieldLabels', {'X': 'hidden field', 'Y': 'hidden field', 'name': 'header label - visible with data', });
lyr_GranamoreStoneDams28_9.set('fieldLabels', {'X': 'hidden field', 'Y': 'hidden field', 'name': 'header label - visible with data', 'description': 'header label - visible with data', });
lyr_GranamoreTimberDams307_10.set('fieldLabels', {'X': 'hidden field', 'Y': 'hidden field', 'Name': 'header label - visible with data', 'description': 'header label - visible with data', 'Date of Construction': 'header label - visible with data', });
lyr_BarnacullianTimberDams489_11.set('fieldLabels', {'X': 'hidden field', 'Y': 'hidden field', 'Name': 'header label - visible with data', });
lyr_BarnacullianStoneDams135_12.set('fieldLabels', {'X': 'hidden field', 'Y': 'hidden field', 'Name': 'header label - visible with data', });
lyr_BarnacullianSheepFleece9_13.set('fieldLabels', {'X': 'hidden field', 'Y': 'hidden field', 'Name': 'header label - visible with data', });
lyr_BarnacullianCoir338_14.set('fieldLabels', {'X': 'hidden field', 'Y': 'hidden field', 'Name': 'header label - visible with data', });
